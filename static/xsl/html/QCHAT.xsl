...
<!--
 * QCHAT.xsl - templates específicas del test QCHAT.
 *
-->
...
<xsl:transform
	...
	xmlns="&XHTMLNS;"
	xmlns:h="&XHTMLNS;"
	xmlns:p="urn:uuid:227e723a-4f6e-11df-bb09-90e6bab72f52"
...
<xsl:template match="h:html" mode="test.includes">
	<script type="text/javascript" src="/scripts/QCHAT">;</script>
</xsl:template>
