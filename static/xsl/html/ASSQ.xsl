...
<!--
 * ASSQ.xsl - templates específicas del test ASSQ.
 *
-->
...
<xsl:transform
	...
	xmlns="&XHTMLNS;"
	xmlns:h="&XHTMLNS;"
	xmlns:p="urn:uuid:686a0262-a7f1-11dd-aa81-001fc6576244"
...
<xsl:template match="h:html" mode="test.includes">
	<script type="text/javascript" src="/scripts/ASSQ">;</script>
</xsl:template>
...
<xsl:template match="sentencia" mode="likert.question-headers">
	...
	<th class="OptionLabel"><xsl:value-of select="tables:text('algo')"/></th>
